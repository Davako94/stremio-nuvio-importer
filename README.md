...
**Stremio NUVIO Importer** è un tool per **NUVIO** che ti permette di portare tutta la tua libreria di film e serie da **Stremio** con un semplice click.

---

## ✨ Come funziona

1. **Esegui** il login del tuo account **STREMIO**
2. *Essegui** il login del tuo account **NUVIO**
3. **Premi** "Sync"
4. **Godit** la tua libreria piena!

**IMPORTANTE** Se avevi delle "Collezioni", "TV" o "Youtube" non verranno lette su NUVIO, ricordati di eliminarle! (in caso, vedrai che su stremio avrai più elementi in libreria)
